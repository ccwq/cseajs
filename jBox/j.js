...
define(function (require) {
    ...
    jBoxConfig.defaults = {
        ...
        top: '36%', /* 窗口离顶部的距离,可以是百分比或像素(如 '100px') */
        border: 5, /* 窗口的外边框像素大小,必须是0以上的整数 */
        opacity: 0.5, /* 窗口隔离层的透明度,如果设置为0,则不显示隔离层 */
        timeout: 0, /* 窗口显示多少毫秒后自动关闭,如果设置为0,则不自动关闭 */
        showType: 'slide', /* 窗口显示的类型,可选值有:show、fade、slide */
        showSpeed: 'slow', /* 窗口显示的速度,可选值有:'slow'、'fast'、表示毫秒的整数 */
    ...
    jBoxConfig.tipDefaults = {
        ...
        opacity: 0.75, /* 窗口隔离层的透明度,如果设置为0,则不显示隔离层 */
        timeout: 1600, /* 提示显示多少毫秒后自动关闭,必须是大于0的整数 */
    ...
    jBoxConfig.messagerDefaults = {
        ...
        timeout: 1800, /* 信息显示多少毫秒后自动关闭,如果设置为0,则不自动关闭 */
    ...
    //默认皮肤配置
    require.async("jBox/Skins2/cgreen/jbox.css");
